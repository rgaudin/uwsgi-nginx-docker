...
environments = [
    {
        ...
        "TEST_STR1": "Hello World from a default Nginx uWSGI Python 3.8 app in a Docker container (default)",
        "TEST_STR2": "Hello World from Nginx uWSGI Python 3.8 app in a Docker container",
        "RUN_TESTS": "1",
    },
    {
        "NAME": "latest",
